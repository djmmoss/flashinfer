...
fused_kda_decode_packed_trace = TraceTemplate(
    ...
    description=(
        "Packed T>=1 Kimi width-four causal convolution, recurrent KDA, and "
        "gated RMSNorm with one cache checkpoint per token."
    ),
    axes={
        "num_sequences": Var(description="Number of independent sequences."),
        "num_tokens": Const(description="Tokens per sequence.", abbrev="t"),
